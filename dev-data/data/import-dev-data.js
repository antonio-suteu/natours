...
// READ JSON FILE
const dataToImport = fs.readFileSync(`${__dirname}/tours-simple.json`, 'utf-8');
...
//in terminal: node dev-data/data/import-dev-data.js --import OR node dev-data/data/import-dev-data.js --delete
